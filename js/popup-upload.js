...
function fncSubmitArquivo(btnSubmit,objeto) {
    ...
    if(tamanhoArquivo > tamanhoMaximo){
        alert('Tamanho máximo do arquivo excedido!\\nTamanho máximo permitido: 2 MB.');
...
function fncInserirArquivo(fomulario, progress, porcentagem, inputFile, arquivoExibicao, caminhoArquivo, tipoArquivo) {
